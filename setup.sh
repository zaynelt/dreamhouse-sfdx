...
HEROKU_TEAM_NAME="sfdc-trailhead-evangelism"

# Descriptive name for the Heroku app
HEROKU_APP_NAME="Dreamhouse SFDX"

# Name of the Heroku apps you'll use
HEROKU_DEV_APP_NAME="dreamhouse-dev$TICKS"
HEROKU_STAGING_APP_NAME="dreamhouse-staging$TICKS"
HEROKU_PROD_APP_NAME="dreamhouse-prod$TICKS"

# Pipeline
HEROKU_PIPELINE_NAME="dh-dx-pipeline-demo"

# Usernames or aliases of the orgs you're using
DEV_HUB_USERNAME="packagingHub"
DEV_USERNAME="DevOrg"
STAGING_USERNAME="StagingOrg"
PROD_USERNAME="dhSFDXProd"

# Repository with your code
GITHUB_REPO="zaynelt/dreamhouse-sfdx"

# Your package name
PACKAGE_NAME="Dreamhouse-SFDX"
